function setMVShortAxes(src,~)
%SETMVSHORTAXES Set the mitral valve short axis value when the user defines
%it
...
switch answer
    case 'End Diastole'
        measurements.A1.ED = mag*scale_factor;
    case 'End Systole'
        measurements.A1.ES = mag*scale_factor;
end
