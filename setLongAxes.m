function [long_axis_ed,long_axis_es] = setLongAxes(src,~)
%SETLONGAXIS Set long axes in four chamber view when the user defines it
...
switch answer
    case 'End Diastole'
        measurements.L.ED = mag*scale_factor;
        long_axis_ed = measurements.L.ED;
    case 'End Systole'
        measurements.L.ES = mag*scale_factor;
        long_axis_es = measurements.L.ES;
end
